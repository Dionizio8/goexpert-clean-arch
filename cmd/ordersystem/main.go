...
import (
	...
	"github.com/Dionizio8/goexpert-clean-arch/internal/event/handler"
...
func main() {
	...
	lisOrderUseCase := NewListOrderUseCase(db)
	...
	orderService := service.NewOrderService(*createOrderUseCase, *lisOrderUseCase)
	...
	srv := graphql_handler.NewDefaultServer(graph.NewExecutableSchema(graph.Config{Resolvers: &graph.Resolver{
		...
		ListOrderUseCase:   *lisOrderUseCase,
	}}))
